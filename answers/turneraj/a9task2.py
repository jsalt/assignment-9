...
"""
 My second task for Assignment 9 that edits a string to remove tabs, replacing them with commas and prints the ExaML result line by line. 
...
def reformat(examl):
	...
	for line in notabs: #printing list line by line
		print(line) 
